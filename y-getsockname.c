...
//////////////////////////////////////////////////
				...
				if(inet_ntop(AF_INET, &clientaddress.sin_addr.s_addr , IP2, strlen(IP2))<0)
				{
...
////////////////////////////////// Process request at new port
				...
				if (getsockname(next_FD, (struct sockaddr *)&sin, &len) == -1)
 					perror("getsockname");
    					...
    					printf("Communication will take place at port %d\n",ntohs(sin.sin_port));
...
//////////////////////////////////////////////////
				recvfrom(P_FD, &ic, sizeof(ictos), 0, (struct sockaddr *)&clientaddress, &address_len);
